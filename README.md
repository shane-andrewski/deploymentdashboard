# Deployment Support Dashboard

This folder is ready to upload to a GitHub repository and publish with GitHub Pages.

## Files
- `index.html` - main dashboard page
- `troubleshooting_guide.html` - device troubleshooting browser page
- `dashboard_data.json` - exported data snapshot
- `exports/` - copied deployment and troubleshooting HTML documents for locations and the shared guide
